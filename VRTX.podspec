Pod::Spec.new do |s|
  ...
  s.source           = {
    :http => "https://github.com/vrtx-fintech/vrtx-ios/releases/download/0.1.13/VRTX.cocoapods.zip",
    ...
    :sha256 => '8dc8cbd026744f5e10a6d2e1b1467cdc014cbd2c502ef4eb6a8c7ecc81c2505a'
  }
