Pod::Spec.new do |s|
  ...
  s.source           = {
    :http => "https://github.com/vrtx-fintech/vrtx-ios/releases/download/0.1.14/VRTX.cocoapods.zip",
    ...
    :sha256 => '5ede65dec69ede526b9b9d14920022ab2780f57076eed7b215fa48e01bd9274d'
  }
