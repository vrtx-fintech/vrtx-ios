Pod::Spec.new do |s|
  ...
  s.source           = {
    :http => "https://github.com/vrtx-fintech/vrtx-ios/releases/download/0.1.4/VRTX.cocoapods.zip",
    ...
    :sha256 => '2dc0a314ce8ca0a4ef008f3ce546dc3fa44136c3f9acc1bc2827fad280d2ddac'
  }
