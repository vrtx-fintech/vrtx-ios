Pod::Spec.new do |s|
  ...
  s.source           = {
    :http => "https://github.com/vrtx-fintech/vrtx-ios/releases/download/0.1.12/VRTX.cocoapods.zip",
    ...
    :sha256 => '1fdfa3a13bfd05838fd716c2a8d8f8b9b4eaa4f30c80992f670fc53d02c3f9af'
  }
